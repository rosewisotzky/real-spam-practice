console.log("the juice aint worth the squeeze if the juice don't look like this")
...
const customerEmail = customers.map(customers => {
           return customers.contacts.email.map(email => {
                return email
            })
        })
